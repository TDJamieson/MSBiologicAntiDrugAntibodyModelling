...
# ==============================================================================                                                                                
  ...
  # R process directories --
    ...
    postProcessingDirectory <- paste0(codeDirectory, 'postMicrosimulationProcesses/')
    
    
    # Cost utility code folder 
    costUtilityCodeDirectory <- paste0(RProjectDirectory, 'costUtilityCode/')
    
    
    # Output processing directory
    outputProcessingDirectory <- paste0(RProjectDirectory, 'outputsCode/')
  ...
  # Folder where model runs are stored --
    
    modelRunsDirectory <- paste0(rootDirectory, 'modelRuns/')
