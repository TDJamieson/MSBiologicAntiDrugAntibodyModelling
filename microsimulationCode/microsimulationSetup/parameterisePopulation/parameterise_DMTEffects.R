...
#==============================================================================# 
  ...
  # Add field to identify if a DMT effect has already been modified
        
        DMTARREffectsDT[, modifiedEffect := NA_integer_]
        
        DMTRRMSEDSSProgressionEffectsDT[, modifiedEffect := NA_integer_]
