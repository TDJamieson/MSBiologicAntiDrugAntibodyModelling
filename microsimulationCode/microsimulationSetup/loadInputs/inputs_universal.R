...
# ----
  ...
  # is not a table
    ...
    DMTTables <- DMTTables[!grepl('_Switch', DMTTables, perl = TRUE)]
    DMTTables <- DMTTables[!grepl('_probabilisticSwitch', DMTTables, perl = TRUE)]
    DMTTables <- DMTTables[!grepl('singleSpecifiedStartingDMTID', DMTTables, perl = TRUE)]
    DMTTables <- DMTTables[!grepl('seedRun_', DMTTables, perl = TRUE)]
