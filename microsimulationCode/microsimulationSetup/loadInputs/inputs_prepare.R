  ...
  # ---------
    ...
    # identification
      ...
      annualRelapseRiskInteractionCoefficients <- 
        annualRelapseRisk[grepl("onsetAgeBand", Variable, perl = TRUE)]
    ...
    # Select gender row
      ...
      annualRelapseRiskGenderCoefficients <- 
        annualRelapseRisk[grepl("femaleGender", Variable, perl = TRUE)]
    ...
    # Select sensory onset row 
      ...
      annualRelapseRiskSensoryCoefficients <- 
          annualRelapseRisk[grepl("sensory", Variable, perl = TRUE)]
    ...
    # Select intercept row
      ...
      annualRelapseRiskInterceptCoefficients <- 
          annualRelapseRisk[grepl("(Intercept)", Variable, perl = TRUE)]
